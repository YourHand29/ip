...
When creating or proposing a commit message for the reviewed changes, follow the `craft-commit-message` skill. Every commit message must include an imperative subject and a detailed body explaining what changed and why.
